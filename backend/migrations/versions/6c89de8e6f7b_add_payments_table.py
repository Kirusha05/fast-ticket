...
def upgrade() -> None:
    payment_status_enum = sa.Enum('pending', 'succeeded', 'expired', name='payment_status')
    ...
    op.create_index('ix_payments_booking_id', 'payments', ['booking_id'], unique=True)  # only one payment row per booking

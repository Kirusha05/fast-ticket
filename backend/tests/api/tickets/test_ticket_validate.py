...
async def test_ticket_validate_already_used(test_client: TestClient, db_session: AsyncConnection, override_current_user_admin):
    """
    Setup:
      Users:
        - User 1 (u-11111111-...), "Test User"
    ...
    request = {
        "ticket_id": "t-10000000-0000-0000-0000-000000000002"
    }
    ...
    assert data["detail"] == "Ticket already used"